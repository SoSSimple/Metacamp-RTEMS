...
namespace SmartConnector.Edukit
{
    class Program
    {
        ...
        public class Service
        {
            ...
            public Task<Boolean> Connect()
            {
                try
                {
                    ...
                    mqttClient.Subscribe(new string[] { edgeConfigResult.EdukitId_2 }, new byte[] { 0 });
            ...
            private void XGTWrite(XGTClass xGTClass, string ReceivedMessage)
            {
                ...
                else if (test.tagId == "19") // Yellow led ON/OFF
                {
                    if (test.value == "0")
                    {
                        pAddress2.Address = "2D";
                        pAddress2.Data = "0";
                ...
                else if (test.tagId == "35") // Emergency ON/OFF
                {
                    if (test.value == "0")
                    {
                        pAddress2.Address = "20";
                        pAddress2.Data = "0";
                ...
                else if (test.tagId == "50") // Start_PB
                {
                    if (test.value == "0")
                    {
                        pAddress2.Address = "21";
                        pAddress2.Data = "0";
                ...
                else if (test.tagId == "52") //No1_Count_Reset
                {
                    pAddress2.Address = "130";
                    pAddress2.Data = "1";
                    xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
                ...
                else if (test.tagId == "53") //No2_Count_Reset
                {
                    pAddress2.Address = "131";
                    pAddress2.Data = "1";
                    xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
                ...
                else if (test.tagId == "54") //No2_Count_Reset
                {
                    pAddress2.Address = "132";
                    pAddress2.Data = "1";
                    xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
                ...
                else if (test.tagId == "55") //Count_Reset
                {
                    pAddress2.Address = "133";
                    pAddress2.Data = "1";
                    xGTClass.Write(XGT_DataType.Bit, pAddress2, XGT_MemoryType.SubRelay_M, 0);
            ...
            private void ConnectionStart(int DelayTime, XGTClass xGTClass, string ip, int port)
            {
                ...
                // 읽어올 데이터를 XGTAddressData로 생성
                XGTAddressData Start_PB = new XGTAddressData(); //시작버튼
                XGTAddressData Stop_PB = new XGTAddressData();  //정지버튼
                XGTAddressData No1_Count_Reset = new XGTAddressData();  //1호기 생산량 리셋
                XGTAddressData No2_Count_Reset = new XGTAddressData();  //2호기 생산량 리셋
                XGTAddressData No3_Count_Reset = new XGTAddressData();  //3호기 생산량 리셋
                XGTAddressData Count_Reset = new XGTAddressData();  //양품 생산량 리셋
                ...
                Start_PB.Address = "21"; //
                Start_PB.Name = "Start_PB";
                Start_PB.TagId = "50";

                Stop_PB.Address = "22"; //
                Stop_PB.Name = "Stop_PB";
                Stop_PB.TagId = "51";

                No1_Count_Reset.Address = "130"; //
                No1_Count_Reset.Name = "No1_Count_Reset";
                No1_Count_Reset.TagId = "52";

                No2_Count_Reset.Address = "131"; //
                No2_Count_Reset.Name = "No2_Count_Reset";
                No2_Count_Reset.TagId = "53";

                No3_Count_Reset.Address = "132"; //
                No3_Count_Reset.Name = "No3_Count_Reset";
                No3_Count_Reset.TagId = "54";

                Count_Reset.Address = "133"; //
                Count_Reset.Name = "Count_Reset";
                Count_Reset.TagId = "55";
                ...
                BitAddressList.Add(Start_PB, "M"); //
                BitAddressList.Add(Stop_PB, "M"); //
                BitAddressList.Add(No1_Count_Reset, "M"); //
                BitAddressList.Add(No2_Count_Reset, "M"); //
                BitAddressList.Add(No3_Count_Reset, "M"); //
                BitAddressList.Add(Count_Reset, "M"); //
                ...
                BitAddressList.Add(Emergency, "M");
        ...
        public class EdgeConfig
        {
            ...
            public string EdukitId_2 { get; set; }
