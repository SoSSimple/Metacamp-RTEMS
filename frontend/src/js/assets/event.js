...
class Event {
  constructor(element, edukit) {
    ...
    const inputAddressElement = eventElement.appendChild(
      document.createElement("input")
    );
    inputAddressElement.placeholder = "MQTT Host 입력";

    const inputPortElement = eventElement.appendChild(
      document.createElement("input")
    );
    inputPortElement.placeholder = "MQTT Port 입력";

    const inputPathElement = eventElement.appendChild(
      document.createElement("input")
    );
    inputPathElement.placeholder = "MQTT Path 입력";

    const inputTopicElement = eventElement.appendChild(
      document.createElement("input")
    );
    inputTopicElement.placeholder = "MQTT Topic 입력";

    const buttonElement = eventElement.appendChild(
      document.createElement("button")
    );
    buttonElement.innerText = "Connect";

    const statusElement = eventElement.appendChild(
